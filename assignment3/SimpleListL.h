// SimpleListL.h - using a linked list data structure
#ifndef SIMPLELIST
#define SIMPLELIST
...
public:
    ...
    void setCurrentToIndex(int i);
    // sets the current to specified index by incrementing head by going next by next
